# Svensk Ragg Frontend

React/TypeScript-frontend för Svensk Ragg. Frontenden använder FastAPI-backenden för streaming-svar, källor, pipeline-status och källdetaljer.
...
```text
${VITE_BACKEND_URL}/api/svensk-ragg/agent/query/stream
```
