...
import { Database, PanelLeft, Shield } from "lucide-react";
    ...
    <div className="w-screen h-screen overflow-hidden flex bg-app-bg text-[#E2E8F0] font-ui select-none relative">
      ...
      <ErrorBoundary>
        ...
        <div className="flex-1 flex flex-col min-w-0 h-full relative z-10 bg-transparent">
          ...
          <div className="border-b border-white/[0.05] bg-slate-950/35 px-6 py-2 shrink-0 z-20">
            <div className="mx-auto flex max-w-5xl items-start gap-2.5 text-slate-300">
