    ...
    <div className="w-full h-full flex flex-col p-4 sm:p-6 pointer-events-none bg-transparent">
      ...
      <header className="flex items-center justify-between text-stone-500 mb-4 pointer-events-auto z-50 bg-transparent">
        <div className="flex items-center gap-3">
          ...
          {!isHeroMode && (
            <span className="text-sm font-medium tracking-wider">
              <span className="bg-gradient-to-r from-stone-800 via-teal-700 to-stone-800 bg-clip-text text-transparent animate-gradient">RAG OFFENTLIGA DOKUMENT</span>{" "}
        ...
        <div
          ...
          title="Lokal utvecklingsvy"
          role="status"
          aria-label="Lokal utvecklingsvy"
        >
          <span className="relative flex h-2 w-2">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
            <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500" />
          </span>
          <span className="text-xs font-medium text-emerald-700">Local</span>
        </div>
      </header>
