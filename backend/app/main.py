"""
Svensk RAG Backend - Main Application
...
async def lifespan(app: FastAPI):
    ...
    # Initialize Svensk RAG services
    try:
        logger.info("Initializing Svensk RAG services...")
...
app = FastAPI(
    ...
    description="Backend for Svensk RAG - Swedish legal document RAG system",
...
app.include_router(
    ...
    prefix="/api/constitutional",
    tags=["constitutional"],
)
app.include_router(
    constitutional_router,
    prefix="/api/svensk-rag",
    tags=["svensk-rag"],
)
...
# WebSocket endpoints
app.websocket("/ws/harvest")(harvest_websocket)  # Svensk RAG: Live harvest progress
...
async def root():
    ...
    return {
        ...
        "version": settings.app_version,
        "docs": "/docs",
        "health": "/api/svensk-rag/health",
        "legacy_health": "/api/constitutional/health",
