...
from ..core.exceptions import QueryClassificationError
...
class QueryProcessorService(BaseService):
    ...
    SWEDISH_STOPWORDS = {
        'och', 'i', 'att', 'en', 'ett', 'det', 'som', 'av', 'för', 'med',
        'till', 'på', 'är', 'om', 'har', 'de', 'den', 'vara', 'vad',
        'var', 'hur', 'när', 'kan', 'ska', 'inte', 'eller', 'men', 'så',
        'från', 'vid', 'ut', 'upp', 'få', 'ta', 'ge', 'göra', 'finns',
        'alla', 'än', 'dessa', 'detta', 'vilka', 'vilket', 'vilken', 'sin',
        'sina', 'sig', 'oss', 'vi', 'ni', 'dom', 'dem', 'deras', 'vår',
        'vårt', 'våra', 'han', 'hon', 'hennes', 'hans', 'ja', 'nej',
        'bara', 'mycket', 'mer', 'mest', 'enligt', 'säger', 'gäller',
        'berätta', 'förklara', 'beskriv',
    }
        ...
        for pattern in self.CHAT_PATTERNS:
            if re.match(pattern, query_lower, re.IGNORECASE):
                return QueryClassification(
                    ...
                    reason=f"Matched CHAT pattern: {pattern}"
                )
        ...
        for pattern in self.EVIDENCE_PATTERNS:
            if re.search(pattern, query_lower, re.IGNORECASE):
                return QueryClassification(
                    ...
                    reason=f"Matched EVIDENCE pattern: {pattern}"
                )
    ...
    def decontextualize_query(
        ...
        detected_entities = self._extract_legal_entities(
            f"{last_user_q} {last_assistant_response}"
        )
