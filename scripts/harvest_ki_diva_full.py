#!/usr/bin/env python3
"""
FULL HARVEST: Karolinska Institutet via DiVA OAI-PMH
=====================================================
Endpoint: http://ki.diva-portal.org/dice/oai
...
def parse_mods_record(record_elem):
    ...
    try:
        ...
        # Find MODS element (might be wrapped differently)
...
def main():
    print("=" * 60)
    print("FULL HARVEST: Karolinska Institutet DiVA")
    print("=" * 60)
